...
DATA_PATH = os.path.join(DATA_DIR, "climate_instability_finalized.csv")
...
# =========================
# Step 5: Save Model and Scaler (FIXED)
# =========================
...
def compute_features_from_nasa(daily_data):
    ...
    heatwave_frequency = np.sum(temp_max > 40)

    return avg_mean_temp, total_rainfall, heatwave_frequency

# =========================
# Step 8: Predict Climate Index
# =========================
