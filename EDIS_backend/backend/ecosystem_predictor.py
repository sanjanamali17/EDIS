...
def initialize_predictor():
    ...
    data_files = [
        os.path.join(DATA_DIR, 'climate_instability_finalized.csv'),
        os.path.join(DATA_DIR, 'soil_degradation_finalized.csv'),
        os.path.join(DATA_DIR, 'vegetation_stress_finalized.csv'),
        os.path.join(DATA_DIR, 'human_pressure_finalized.csv'),
        os.path.join(DATA_DIR, 'biodiversity_loss_finalized.csv')
    ]
    
    # Try to load combined data or individual files
    combined_data_path = os.path.join(DATA_DIR, 'ecosystem_historical_data.csv')
